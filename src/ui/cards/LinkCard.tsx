...
import { TikTokIcon } from '@/config/icons';
import { trackLinkClick, trackSubLinkClick } from '@/lib/analytics';
import Image from 'next/image';

// Registry de ícones - resolve strings para componentes
const iconRegistry: Record<string, LucideIcon | React.FC<any>> = {
  Calendar,
  Youtube,
  Instagram,
  Utensils,
...
export const LinkCard: React.FC<LinkCardProps> = ({ item, index }) => {
  ...
  const Icon = iconRegistry[item.icon] || Calendar; // Fallback para Calendar se não encontrar
